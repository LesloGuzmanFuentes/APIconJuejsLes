                        ...
                        <tbody>
                            <tr v-for="(Usuario,indice) of usuarios">                                
                                ...
                                <div class="btn-group" role="group">
                                    <button class="btn btn-secondary" title="Editar" @click="btnEditar(usuario.id, usuario.correo, usuario.ocupacion, usuario.stock)"><i class="fas fa-pencil-alt"></i></button>    
